...
Replace this section with the supported versions for `notionstash`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `notionstash` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in notionstash.
